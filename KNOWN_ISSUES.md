...
guaranteed the `0/529`. **`T-0046` owned `required` and CLOSED it at `1c302d8`** — the commit that
made the array answerable, and it closed both halves at once: `order_blocks` joined `primitives.required` in
