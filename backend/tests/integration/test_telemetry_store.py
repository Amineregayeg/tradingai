...
def _evaluation(declared, *, decision="SKIP", seq=1, evaluation_id=None) -> dict:
    ...
    return rec.setup_evaluation(
        ...
        primitives={"swing_points": [], "structure_boxes": [], "imbalances": [],
                    ...
                    # REQUIRED from T-0046, the commit that implemented PRIM-007 and so made
                    # an empty array answerable: `[]` means the walk ran and found nothing.
                    "order_blocks": []},
...
async def test_query_columns_mirror_the_payload(db_session, declared):
    ...
    assert row.rule_registry_version == "1.2.2"  # T-0045: round-3 patch, 1.2.1 -> 1.2.2
